      ...
      <Card className="min-w-0">
        <CardHeader className="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
          ...
          <div className="surface-panel rounded-[1.75rem] px-5 py-4">
            ...
            <p className="mt-2 text-4xl font-semibold text-white">{cgpa}</p>
        ...
        <CardContent className="space-y-5">
          ...
          {validationError ? (
            ...
            <div className="rounded-2xl border border-indigo-500/20 bg-indigo-500/10 px-4 py-3 text-sm text-indigo-300">
